...
This endpoint uses RunPod's pre-built vLLM Worker template for optimized LLM inference.
...
HF_TOKEN=<set in RunPod dashboard>
```
...
**Base URL:** `https://api.runpod.ai/v2/mo5vt1mlci0mtw/openai/v1`
